...
(function (h) {
  ...
  function rb(a) {
    var b = a.oClasses,
      ...
      f = a.aanFeatures,
      g =
        '<div class="input-group m-b" style="margin-bottom:-1px;margin-left:3px;"><input type="search" id="search" class="form-control form-control-sm mysearch ' +
        b.sFilterInput +
        '"/><div class="input-group-prepend"><span class="btn btn-sm btn-primary" style="border-bottom-right-radius:3px;border-top-right-radius:3px;">Go!</span></div></div>',
      j = d.sSearch,
